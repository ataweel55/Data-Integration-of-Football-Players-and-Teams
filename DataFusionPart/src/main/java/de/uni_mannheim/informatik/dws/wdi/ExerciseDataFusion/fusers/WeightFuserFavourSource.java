...
/**
 * {@link AttributeValueFuser} for the weight of {@link Player}s.
 * 
 */
public class WeightFuserFavourSource extends AttributeValueFuser<String, Player, Attribute> {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Player.WEIGHT,
