...
/**
 * {@link AttributeValueFuser} for the LName of {@link Player}s.
 * 
 */
public class LNameFuserFavourSource extends AttributeValueFuser<String, Player, Attribute> {

	public LNameFuserFavourSource() {
		super(new FavourSources<String, Player, Attribute>());
	}

	@Override
	public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Player.L_NAME);
	}
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setlName(fused.getValue());
		fusedRecord.setAttributeProvenance(Player.L_NAME,
