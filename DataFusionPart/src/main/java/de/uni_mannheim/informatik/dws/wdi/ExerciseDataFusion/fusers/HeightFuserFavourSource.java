...
/**
 * {@link AttributeValueFuser} for the height of {@link Player}s.
 * 
 */
public class HeightFuserFavourSource extends AttributeValueFuser<String, Player, Attribute> {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setAttributeProvenance(Player.HEIGHT,
