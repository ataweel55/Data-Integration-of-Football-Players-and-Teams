 ...
 *
 */
public class FNameFuserVoting extends AttributeValueFuser<String, Player, Attribute> {

	public FNameFuserVoting() {
	...
	public void fuse(RecordGroup<Player, Attribute> group, Player fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
		...
		fusedRecord.setfName(fused.getValue());
		fusedRecord.setAttributeProvenance(Player.F_NAME,
