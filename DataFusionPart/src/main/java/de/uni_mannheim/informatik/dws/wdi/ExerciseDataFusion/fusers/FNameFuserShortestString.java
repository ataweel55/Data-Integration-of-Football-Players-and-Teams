...
/**
 * {@link AttributeValueFuser} for the last name of {@link Player}s.
 * 
 */
public class FNameFuserShortestString extends
		AttributeValueFuser<String, Player, Attribute> {

	public FNameFuserShortestString() {
		super(new ShortestString<Player, Attribute>());
	}

	@Override
	public boolean hasValue(Player record, Correspondence<Attribute, Matchable> correspondence) {
		return record.hasValue(Player.F_NAME);
	}
